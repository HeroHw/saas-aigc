 ...
 * @extends IRepository<Agent>
 */
final class AgentRepository extends IRepository
{
    public function __construct(protected readonly Agent $model) {}
    ...
    public function getTopLevelAgents(): \Hyperf\Collection\Collection
    {
        return $this->model->newQuery()
            ->whereNull('parent_id')
            ->orderBy('created_at')
    ...
    public function getChildrenAgents(int $parentId): \Hyperf\Collection\Collection
    {
        return $this->model->newQuery()
    ...
    public function getExpiringAgents(int $days = 7): \Hyperf\Collection\Collection
    {
        return $this->model->newQuery()
    ...
    public function getHighQuotaUsageAgents(float $threshold = 0.8): \Hyperf\Collection\Collection
    {
        return $this->model->newQuery()
    ...
    public function getAgentsByPath(string $path): \Hyperf\Collection\Collection
    {
        return $this->model->newQuery()
